...
const GenerateHTMLForContent = (props) => {
	return (
		<div className="mt-2">
			...
			<h2 id='Deep Packet Inspection (DPI)'>Deep Packet Inspection (DPI)</h2>
			...
			<h2 id='Intrusion Detection and Prevention System (IDS/IPS)'>Intrusion Detection and Prevention System (IDS/IPS)</h2>
